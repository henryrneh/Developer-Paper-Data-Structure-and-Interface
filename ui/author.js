    ...
    <tr>
        <th>
            ...
            <input class="form-control form-control-sm m-2"
                v-model="Author_IDFilter"
                v-on:keyup="FilterFn()"
                placeholder="Filter">

                <button type="button" class="btn btn-light"
                @click="sortResult('Author_ID',true)">
                ...
                <button type="button" class="btn btn-light"
                @click="sortResult('Author_ID',false)">
...
<tbody>
    <tr v-for="au in author">
        ...
        <td>
            ...
            <button type="button"
            @click="deleteClick(au.Author_ID)"
            class="btn btn-light mr-1">
    ...
    <div class="d-flex flex-row bd-highlight mb-3">
        <div class="p-2 w-50 bd-highlight">
            <div class="input-group mb-3">
                <span class="input-group-text">Author_ID</span>
                <input type="bigint" class="form-control" v-model="Author_ID">
            </div>
...
methods:{
    refreshData(){
        ...
        .then((response)=>{
            ...
            this.authorWithoutFilter=response.data;
        });
    ...
    editClick(au){
        ...
        this.Author_ID=au.Author_ID;
        this.Paper_ID=au.Paper_ID;
        this.Author=au.Author;
    },
    createClick(){
        axios.post(variables.API_URL+"author",{
    ...
    updateClick(){
        axios.put(variables.API_URL+"author",{
            Author_ID:this.Author_ID,
            Paper_ID:this.Paper_ID,
            Author:this.Author,
        })
    ...
    deleteClick(id){
        ...
        axios.delete(variables.API_URL+"author/"+id)
        .then((response)=>{
            this.refreshData();
            alert(response.data);
        });
    ...
    FilterFn(){
        var Author_IDFilter=this.Author_IDFilter;
        var Paper_IDFilter=this.Paper_IDFilter;
        var AuthorFilter=this.AuthorFilter;

        this.author=this.authorWithoutFilter.filter(
            function(el){
                return (el.Author_ID || '').toString().toLowerCase().includes(
                    Author_IDFilter.toString().trim().toLowerCase()
                )
                &&
    ...
    sortResult(prop,asc){
        this.author=this.authorWithoutFilter.sort(function(a,b){
            if(asc){
